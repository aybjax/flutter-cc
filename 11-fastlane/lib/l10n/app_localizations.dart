...
abstract class AppLocalizations {
  ...
  /// Label for the environment section
  ///
  /// In en, this message translates to:
  /// **'Environment'**
  String get environmentLabel;

  /// Label for the build flavor
  ///
  /// In en, this message translates to:
  /// **'Flavor'**
  String get flavorLabel;

  /// Label for the API URL
  ///
  /// In en, this message translates to:
  /// **'API URL'**
  String get apiUrlLabel;

  /// Label for the version info
  ///
  /// In en, this message translates to:
  /// **'Version'**
  ...
  /// Label for the build mode (debug/profile/release)
  ///
  /// In en, this message translates to:
  /// **'Build Mode'**
