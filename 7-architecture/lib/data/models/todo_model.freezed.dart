...
mixin _$TodoModel {
  int get id =>
      throw _privateConstructorUsedError; // The Go backend uses snake_case; JsonKey maps to Dart's camelCase
...
abstract class $TodoModelCopyWith<$Res> {
  ...
  $Res call({
    ...
    String title,
    String description,
    @JsonKey(name: 'checked') bool isChecked,
    String? image,
  });
}
...
class _$TodoModelImpl extends _TodoModel {
  const _$TodoModelImpl({
    ...
    required this.title,
    this.description = '',
    @JsonKey(name: 'checked') this.isChecked = false,
    this.image,
  }) : super._();
  ...
  @override
  String toString() {
    return 'TodoModel(id: $id, userId: $userId, title: $title, description: $description, isChecked: $isChecked, image: $image)';
  }
...
abstract class _TodoModel extends TodoModel {
  const factory _TodoModel({
    ...
    final String description,
    @JsonKey(name: 'checked') final bool isChecked,
    final String? image,
  }) = _$TodoModelImpl;
  ...
  @override
  int get id; // The Go backend uses snake_case; JsonKey maps to Dart's camelCase
  @override
  @JsonKey(name: 'user_id')
  int get userId;
  @override
