...
@override
String toString() {
  return 'ChatMessageEntity(id: $id, text: $text, senderName: $senderName, isLocal: $isLocal, sentAt: $sentAt)';
}
...
class _ChatMessageEntity implements ChatMessageEntity {
  const _ChatMessageEntity({required this.id, required this.text, required this.senderName, this.isLocal = false, required this.sentAt});
