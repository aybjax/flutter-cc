...
const CategorySchema = CollectionSchema(
  ...
  indexes: {
    ...
    r'sortKey_colorValue': IndexSchema(
      id: -519696963712784825,
      name: r'sortKey_colorValue',
      unique: false,
      replace: false,
      properties: [
        IndexPropertySchema(
...
int _categoryEstimateSize(
  ...
  bytesCount += 3 + object.sortKey.length * 3;
  return bytesCount;
}
...
void _categorySerialize(
  ...
  writer.writeString(offsets[3], object.sortKey);
}
...
Category _categoryDeserialize(
  ...
  object.sortKey = reader.readString(offsets[3]);
  return object;
}
...
extension CategoryQueryWhere on QueryBuilder<Category, Category, QWhereClause> {
  ...
  QueryBuilder<Category, Category, QAfterWhereClause>
      sortKeyEqualToAnyColorValue(String sortKey) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'sortKey_colorValue',
        value: [sortKey],
      ));
    });
  }
  ...
  QueryBuilder<Category, Category, QAfterWhereClause>
      sortKeyNotEqualToAnyColorValue(String sortKey) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
  ...
  QueryBuilder<Category, Category, QAfterWhereClause> sortKeyColorValueEqualTo(
      String sortKey, int colorValue) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'sortKey_colorValue',
        value: [sortKey, colorValue],
      ));
    });
  }

  QueryBuilder<Category, Category, QAfterWhereClause>
      sortKeyEqualToColorValueNotEqualTo(String sortKey, int colorValue) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
              indexName: r'sortKey_colorValue',
              lower: [sortKey],
              upper: [sortKey, colorValue],
              includeUpper: false,
            ))
            .addWhereClause(IndexWhereClause.between(
              indexName: r'sortKey_colorValue',
              lower: [sortKey, colorValue],
              includeLower: false,
              upper: [sortKey],
            ));
      } else {
  ...
  QueryBuilder<Category, Category, QAfterWhereClause>
      sortKeyEqualToColorValueGreaterThan(
    String sortKey,
    int colorValue, {
    bool include = false,
  }) {
  ...
  QueryBuilder<Category, Category, QAfterWhereClause>
      sortKeyEqualToColorValueLessThan(
    String sortKey,
    int colorValue, {
    bool include = false,
  }) {
  ...
  QueryBuilder<Category, Category, QAfterWhereClause>
      sortKeyEqualToColorValueBetween(
    String sortKey,
    int lowerColorValue,
    int upperColorValue, {
    bool includeLower = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'sortKey_colorValue',
        lower: [sortKey, lowerColorValue],
        includeLower: includeLower,
        upper: [sortKey, upperColorValue],
        includeUpper: includeUpper,
      ));
    });
  }
...
extension CategoryQueryFilter
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> sortKeyEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> sortKeyGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> sortKeyLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> sortKeyBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> sortKeyStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> sortKeyEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> sortKeyContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> sortKeyMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> sortKeyIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'sortKey',
        value: '',
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> sortKeyIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'sortKey',
        value: '',
...
extension CategoryQuerySortBy on QueryBuilder<Category, Category, QSortBy> {
  ...
  QueryBuilder<Category, Category, QAfterSortBy> sortBySortKey() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sortKey', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> sortBySortKeyDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQuerySortThenBy
  ...
  QueryBuilder<Category, Category, QAfterSortBy> thenBySortKey() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sortKey', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> thenBySortKeyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sortKey', Sort.desc);
    });
  }
...
extension CategoryQueryWhereDistinct
  ...
  QueryBuilder<Category, Category, QDistinct> distinctBySortKey(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'sortKey', caseSensitive: caseSensitive);
    });
  }
}
...
extension CategoryQueryProperty
  ...
  QueryBuilder<Category, String, QQueryOperations> sortKeyProperty() {
    return QueryBuilder.apply(this, (query) {
